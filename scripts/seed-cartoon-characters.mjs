...
// pitch_ratio drives ffmpeg's asetrate trick worker-side (pitch + speed move
// together, like a classic chipmunk/slow-giant effect) — see
// buildFilterComplex in worker/index.js. openai_voice is one of OpenAI's
